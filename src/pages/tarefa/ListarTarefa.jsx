...
const ListarTarefa = () => {
  ...
  const [sortColumn, setSortColumn] = useState('inicioTarefa');
            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
              <TableHead>
                <TableRow>
                  ...
                  <TableCell align="right" onClick={() => sortTarefas('inicioTarefa')} style={{ cursor: 'pointer' }}>
                    Data de Início
                  </TableCell>
                  <TableCell align="right" onClick={() => sortTarefas('fimTarefa')} style={{ cursor: 'pointer' }}>
                    Data de Finalização
                  </TableCell>
